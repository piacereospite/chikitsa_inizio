...
<a class="add" href="<?php echo site_url("contact/add"); ?>" title="Add"   ></a>
<table class="table_style">
    ...
    <tr <?php if ($i%2 == 0) { echo "class='alt'"; } ?> >
        ...
        <td><a class="delete" title="Delete" href="<?php echo site_url("contact/delete/" . $contact['contact_id']); ?>"></a></td>
    </tr>
    <?php $i++; ?>
    <?php endforeach ?>
</table>
